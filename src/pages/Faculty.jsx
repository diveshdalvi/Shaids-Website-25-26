...
export default function Faculty() {
    const mentors = [
        ...
        { name: "Mr.Anil Satyadeo Londhe", image: Anilsir, exp: "Assistant Professor" },
        { name: "Mrs.Monal Nilesh Malge", image: Monal, exp: "Assistant Professor" },
        { name: "Mrs.Neha Kunal Kale", image: neha, exp: "Assistant Professor" },
        { name: "Mrs. Deepti Jeetu Janjani", image: deepti,exp: "Assistant Professor" },
        { name: "Mrs. Anjali Devi Milind Patil", image: Anjali , exp: "Assistant Professor" },
        { name: "Mrs. Irin Anna Solomone", image: irin, exp: "Assistant Professor"},
        { name: "Mrs.Monal Nilesh Malge", image: Monal, exp: "Assistant Professor" },
        { name: "Mrs. Poonam Amit Kamble", image: poonam , exp: "Assistant Professor"},
        { name: "Mrs. Shraddha Anant Narhari(Kawji)", image: shraddha, exp: "Assistant Professor" },
        { name: "Mrs. Amita Priyadarshan Suke", image: maam , exp: "Assistant Professor"},
        { name: "Mrs. Aarti Raman Sonawane", image: arti , exp: "Assistant Professor"},
        { name: "Mrs. Swati Sankesh Parhad", image: Swati , exp: "Assistant Professor"},
