...
export default function Events() {
  ...
  return (
    ...
    <h2 className="text-white text-2xl font-NordBold">Welcome to SHAIDS Events Hub!</h2>
    ...
    <h4 className="text-white text-lg font-NordBold">Explore. Innovate. Connect</h4> 
    <p className="text-[#A576DF] text-sm font-Outfit font-semibold px-4">
      ...
      <span className="block text-[#A576DF]">Empower your future in AI & Data Science with SHAIDS.</span>
    </p>
  </div>
        ...
        <div className="sm:flex items-center gap-10 hidden p-10 mb-10 justify-center"> 
          <div className="flex flex-col gap-4">
            ...
            Welcome to <h1 className="text-[#A576DF]"> SHAIDS Events  </h1> Hub! <br/>
            </h1>

            <h4 className="text-white text-2xl 2xl:text-3xl font-NordBold justify-right"> Explore. Innovate. Connect</h4> 

            <h5 className="text-white  text-left text-lg 3xl:text-xl font-Outfit font-semibold">
            Join us for engaging workshops,<br/>inspiring seminars, and exclusive networking opportunities.<br/>
            <h5 className="text-[#A576DF]"> Empower your future in AI & Data <br/>Science with SHAIDS. </h5>
            </h5>
          </div>
